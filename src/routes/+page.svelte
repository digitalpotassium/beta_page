...
<main class="splash-container" class:loading={animationPhase === 'loading'} class:reveal={animationPhase === 'reveal'} class:particles={animationPhase === 'particles'} class:complete={animationPhase === 'complete'}>
	...
	<div class="content">
		<div class="logo-container">
			<h1 class="main-title">
				<span class="letter" style="--delay: 0.1s;">K</span>
				<span class="letter" style="--delay: 0.2s;">I</span>
				<span class="letter" style="--delay: 0.3s;">Z</span>
		...
		<div class="subtitle">
			<span class="typewriter">Where possibilities become reality</span>
		</div>
